// copy of watcher.js which supports non-static contract addresses. This is just a temporary solution
...
async function main() {
    ...
    const stakingAddress = await validatorSetContract.methods.stakingContract().call();
    ...
    web3.eth.subscribe('newBlockHeaders', function (error, result) {
        ...
        if (blockHeader.number) {
            ...
            if (posdaoTransition > blockHeader.number) {
                console.log(`POSDAO transition scheduled at block ${posdaoTransition}`);
            } else {
                ...
                const events = await validatorSetContract.getPastEvents('InitiateChange', {
